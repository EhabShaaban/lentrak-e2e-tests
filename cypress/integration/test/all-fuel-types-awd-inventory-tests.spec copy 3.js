...
describe('Create new AWD inventory with multiple fuel types test suite', function() {
    ...
    it('Create AWD, gasoline fuel, automatic, 8 cylinders, sedan type & 2 doors', function(){
    ...
    it('Create AWD, diesel fuel, automatic, 8 cylinders, sedan type & 2 doors', function(){
        createInv.vinId().type(inventoryData.generalInfo.vin).type('{enter}')
        createInv.listingMileageId().type(inventoryData.generalInfo.listingMileage)
        createInv.listingPriceInput().type(inventoryData.generalInfo.ListingPrice)
        createInv.exteriorColorDiv().click()
    ...
    it('Create AWD, flex fuel, automatic, 8 cylinders, sedan type & 2 doors', function(){
        createInv.vinId().type(inventoryData.generalInfo.vin).type('{enter}')
        createInv.listingMileageId().type(inventoryData.generalInfo.listingMileage)
        createInv.listingPriceInput().type(inventoryData.generalInfo.ListingPrice)
        createInv.exteriorColorDiv().click()
    ...
    it('Create AWD, hybrid fuel, automatic, 8 cylinders, sedan type & 2 doors', function(){
        createInv.vinId().type(inventoryData.generalInfo.vin).type('{enter}')
        createInv.listingMileageId().type(inventoryData.generalInfo.listingMileage)
        createInv.listingPriceInput().type(inventoryData.generalInfo.ListingPrice)
        createInv.exteriorColorDiv().click()
    ...
    it('Create AWD, electric fuel, automatic, 8 cylinders, sedan type & 2 doors', function(){
        createInv.vinId().type(inventoryData.generalInfo.vin).type('{enter}')
        createInv.listingMileageId().type(inventoryData.generalInfo.listingMileage)
        createInv.listingPriceInput().type(inventoryData.generalInfo.ListingPrice)
        createInv.exteriorColorDiv().click()
    ...
    it('Create AWD, alternate fuel, automatic, 8 cylinders, sedan type & 2 doors', function(){
        createInv.vinId().type(inventoryData.generalInfo.vin).type('{enter}')
        createInv.listingMileageId().type(inventoryData.generalInfo.listingMileage)
        createInv.listingPriceInput().type(inventoryData.generalInfo.ListingPrice)
        createInv.exteriorColorDiv().click()
    ...
    it('Create AWD, other fuel, automatic, 8 cylinders, sedan type & 2 doors', function(){
        createInv.vinId().type(inventoryData.generalInfo.vin).type('{enter}')
        createInv.listingMileageId().type(inventoryData.generalInfo.listingMileage)
        createInv.listingPriceInput().type(inventoryData.generalInfo.ListingPrice)
        createInv.exteriorColorDiv().click()
